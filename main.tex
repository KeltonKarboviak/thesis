...
\documentclass[12pt, oneside, final]{styles/Thesis} % The default font size and one-sided printing (no margin offsets)
...
\hyphenation{op-tical net-works semi-conduc-tor metrics-based}
...
\nomenclature{kts}{knots}
\nomenclature{IAS}{Indicated Airspeed}
\nomenclature{KIAS}{Knots Indicated Airspeed}
\nomenclature{VSI}{Vertical Speed Indicated}
\nomenclature{GA}{General Aviation}
\nomenclature{NGAFID}{National General Aviation Flight Information Database}
\nomenclature{FAA}{Federal Aviation Administration}
\nomenclature{UND}{University of North Dakota}
\nomenclature{GAARD}{General Aviation Airborne Recording Device}
\nomenclature{CPAT}{Critical Phase Analysis Tool}
\nomenclature{CFI}{Certified Flight Instructor}
\nomenclature{AGL}{Above Ground Level}
\nomenclature{RPM}{Revolutions Per Minute}
\nomenclature{LOC}{Loss of Control}
\nomenclature{GPA}{Glide Path Angle}
\nomenclature{FDR}{Flight Data Recorder}

% Adds the Nomenclature line to Table of Contents
