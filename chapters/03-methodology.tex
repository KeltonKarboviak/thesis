...
\note{Not trivial because multiple circuits in a single flight. Lack technology found in commercial aircraft. Flying patterns are highly variable in GA due to flight training.}
    ...
    \note{Make note about how I'll be going up to 500 ft since that is the transition from Initial Climb to Cruising Climb for GA.}
...
\section{Phase of Flight Quality Analysis \& Exceedance Detection} \label{sec:phase_quality}
    ...
    %----------
    \subsection{Takeoff}
    	\note{Insert pseudo-code and description of Takeoff analysis here.}
...
\section{Web Interface}
	...
	\note{Explain what visualizations the web interface will show and how it will ease manual analysis.}
